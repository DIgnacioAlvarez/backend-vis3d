...
import {getAllProducts,postProductHandler,getProductByIdHandler,changeProductHandler,deleteProductByIdHandler} from '../handlers/productsHandler.js'
...
productRoutes.delete("/:id", async (req,res) => await deleteProductByIdHandler(req,res) )
