...
import {getAllProducts,postProductHandler,getProductByIdHandler,getByNameHandler} from '../handlers/productsHandler.js'
...
productRoutes.get("/",  async (req,res) => await getByNameHandler(req,res))
